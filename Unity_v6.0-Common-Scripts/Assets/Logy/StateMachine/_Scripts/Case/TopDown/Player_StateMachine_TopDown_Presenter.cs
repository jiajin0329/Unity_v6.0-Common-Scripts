...
namespace Logy.Unity_Common_v01
{
    ...
    public class Player_StateMachine_TopDown_Presenter
    {
        ...
        public void Initialize()
        {
            ...
            _data.input_model.InputDown_Action += _data.stateMachine.Switch_Direction;
            _data.input_model.Input_Action += _data.stateMachine.Switch_Direction;
            _data.input_model.InputUp_Action += _data.stateMachine.Switch_Direction;
        }
    }
}