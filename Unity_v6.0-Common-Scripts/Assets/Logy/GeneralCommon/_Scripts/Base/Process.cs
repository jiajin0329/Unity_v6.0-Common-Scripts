...
namespace Logy.UnityCommonV01
{
    ...
    public class Process
    {
...
#if UNITY_EDITOR
        public static void CheckInitialize(Process _process)
        {
        ...
        private static void CheckAfterInitialize(Process _process)
        {
        ...
        public static async UniTask CheckInitializeWithUniTask(Process _process)
        {
            Assert.AreEqual(_process.processState, ProcessState.none);
        ...
        public static void CheckBegin(Process _process)
        {
            Assert.AreEqual(_process.processState, ProcessState.initialized);
        ...
        public static async UniTask CheckBeginWithUniTask(Process _process)
        {
            Assert.AreEqual(_process.processState, ProcessState.initialized);
